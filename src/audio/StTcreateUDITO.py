...
#
#  curl -X POST -u "apikey:${WATSON_STT_API_KEY}" --header "Content-Type: application/json" --data "{\"name\": \"es_ES-UDITO\",   \"base_model_name\": \"es-ES_Multimedia\",   \"description\": \"Example custom language model\"}" "${WATSON_STT_URL}/v1/customizations"
